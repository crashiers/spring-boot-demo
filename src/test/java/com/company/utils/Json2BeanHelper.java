...
/**
 * @Description
 * @Author lhy@songchedai.com
 * @Date 2020/5/11 16:43
 * @Copyright 2018 www.songcw.com. All rights reserved.
 **/
public class Json2BeanHelper {
    ...
    public static void main(String[] args) {
        String jsonStr="{\n" +
                ...
                "\"dates\":\"2020-03-11\"\n" +
                "}";
        String dst="C:\\Users\\lee\\Desktop\\上线\\";
        try {
            json2Bean(jsonStr,dst);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
     ...
     * @param jsonStr	json文件  	eg：""
     * @param targetPath		生成JavaBean路径 	eg："jsonFile/"
     * @throws IOException
     */
    @SuppressWarnings("resource")
    public static void json2Bean(String jsonStr, String targetPath) throws IOException {
